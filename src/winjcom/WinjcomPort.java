...
public final class WinjcomPort extends SerialPort
{
    ...
    private volatile long portFd = -1;
    ...
    private native long nativeOpen(String name) throws IOException;
    ...
    private native void nativeSetSerialPortParams (long portFd,
                                                   int baudrate, 
                                                   int dataBits, 
                                                   int stopBits, 
    ...
    public synchronized void setSerialPortParams(int baudrate, 
                                                 int databits, 
                                                 int stopbits, 
                                                 int parity) throws IOException
    {
    ...
    private native int nativeGetPortParam (long portFd, int paramType) throws IOException;
     ...
     */
    private native void nativeSetPortParam (long portFd, int what, int value ) throws IOException;
     ...
     * @param wrToTiCo
     */
    private native void nativeSetCommTimeouts (long portFd, 
                                               int reInTi, 
                                               int reToTiMu, 
                                               int reToTiCo,
                                               int wrToTiMu,
    ...
    private native int nativeGetReceiveTotalTimeoutConstant (long portFd ) throws IOException;
     ...
     * @param what
     */
    private native void nativeSendEscape (long portFd, int what ) throws IOException;
    ...
    private native int nativeGetModemStatus (long fd ) throws IOException;
     ...
     * @throws IOException
     */
    private native void nativeNotifyEnable (long portFd, int what, boolean enable );
    ...
    private native int nativeWriteArray (long portFd, byte[]buff, int offset, int len ) throws IOException;
  
    private native void nativePurgeComm (long portFd ) throws IOException;
    ...
    private native int nativeClearCommError(long portFd, int what ) throws IOException;;

    private native int nativeReadArray (long portFd, byte[] buff, int offset, int len) throws IOException;
    ...
    private native void nativeClose(long portFd) throws IOException;
    ...
    private native int nativeGetCommEvent (long portFd) throws IOException;
